...
export function AppDrawer({ open, onOpenChange }: AppDrawerProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 bottom-0 z-[70] w-[280px] sm:w-[320px] bg-[#0f2319] text-white shadow-2xl transition-transform duration-300 ease-out flex flex-col",
      ...
      {open && showScrollTop && (
        <button
          ...
          className="fixed bottom-24 right-4 z-[80] w-12 h-12 rounded-2xl bg-card border border-border shadow-xl flex items-center justify-center hover:bg-muted transition-colors"
