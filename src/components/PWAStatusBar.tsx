...
export function PWAStatusBar() {
  ...
  return (
    <>
      {/* Offline indicator */}
      {!isOnline && (
        <div className="fixed top-0 left-0 right-0 z-[60] bg-amber-500 text-white px-4 py-2 text-center text-sm font-medium shadow-md">
      ...
      {showInstallBanner && !dismissed && (
        <div className="fixed left-2 right-2 sm:left-4 sm:right-4 z-50 bottom-20 md:bottom-4 animate-fade-in">
